// =======================================================================================
// CONFIGURAÇÃO PRINCIPAL - COM OS SEUS ÍNDICES CORRETOS
// =======================================================================================
const CONFIG = {
...
let estoqueChart = null; // Variável para guardar a instância do nosso gráfico
...
function createOrUpdateChart(labels, estoqueData, vendidoData) {
        ...
        datasets: [
            {
                label: 'Estoque Atual',
                data: estoqueData,
                backgroundColor: 'rgba(93, 64, 55, 0.7)', // Cor Café
            ...
            },
            {
                label: 'Total Vendido',
                data: vendidoData,
                backgroundColor: 'rgba(76, 175, 80, 0.6)', // Cor Verde
    ...
    if (estoqueChart) {
        ...
        estoqueChart.data.datasets[0].data = estoqueData;
        estoqueChart.data.datasets[1].data = vendidoData;
        estoqueChart.update();
    } else {
